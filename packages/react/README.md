...
```tsx
import { Bell } from "@keyline-icons/react"          // stroke,  1,000 icons
import { Bell } from "@keyline-icons/react/two-tone" // two-tone, 1,000 icons
import { Bell } from "@keyline-icons/react/duotone"  // duotone, 1,000 icons
import { Bell } from "@keyline-icons/react/fill"     // fill,    1,000 icons
