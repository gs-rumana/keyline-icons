 ...
 *
 * The dot is the mark of the dot ladder, a filled r=1 painting 2, the size his
 * reference draws against its own stroke. It sits on (12,8): the top wall's
 * inner ink is on 5, and the house gap puts the dot's ink top on 7. It is its
...
const DOT = [
  ...
  'M13 8C13 7.44772 12.5523 7 12 7C11.4477 7 11 7.44772 11 8C11 8.55228 11.4477 9 12 9C12.5523 9 13 8.55228 13 8Z',
];
const BASE = {
  regular: {
...
SETS['tablet-smartphone'] = (style, corners) => {
  const o = PAIR[corners], d = move(DOT[0], 0, -2);
